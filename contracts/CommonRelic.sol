...
// 1. Define the Interface so this contract knows how to talk to the Registry
...
contract CommonRelic is ERC1155, Ownable {
    ...
    IGameRegistry public immutable gameRegistry;// to fetch game ratings
    mapping(uint256 => uint256) public baseValues; // relicType => base PXL value
    ...
    }//only owner can mint relics i.e in this case the Gamregistry
    ...
    {
        //Fetching game's rating from the external Registry contract
        ...
        //The math
        uint256 value = (baseValues[relicType] * rating) / 500;
