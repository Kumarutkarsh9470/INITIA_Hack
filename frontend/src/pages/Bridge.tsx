...
export default function Bridge() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* IBC Status Notice */}
      <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4 flex items-start gap-3 animate-fade-in-up">
        ...
        <div>
          <p className="text-sm font-medium text-indigo-800">IBC Relayer Status</p>
