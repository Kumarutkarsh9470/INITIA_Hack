/**
 * Marketplace.tsx — TEAMMATE C BUILDS THIS
 *
 * See the Builder Guide for full instructions and AI prompt.
 * Use ProfileDashboard.tsx as your reference for all patterns.
 *
 * Contract: Marketplace at ADDRESSES.Marketplace
 *
 * Key functions:
 *   Read: nextListingId(), listings(id)
 *   Write (via TBA): setApprovalForAll + listItem, approve + buyItem
 *   Fee: 2.5% from seller
 */
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6">
      <div className="max-w-md text-center space-y-4">
        ...
        <p className="text-gray-500 text-sm">
          Browse listings · List items for sale · Buy with any game token
        </p>
        <Link
          to="/profile"
